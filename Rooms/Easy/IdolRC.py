...
def run(player, screen):
    baseM.showText(player, "A golden idol stands in the middle of the hallway",screen)
    baseM.showText(player, "Hack pieces off or touch the idol?",screen)
    choice = baseM.showText(player, "[hack pieces, touch idol]",screen)
    thisIdol = Idol()
    while True:
        if choice.lower() in ["hack pieces","hack", "h"]:
            ...
            baseM.showText(player, "The idol shrinks in size until it can fit in your backpack",screen)
