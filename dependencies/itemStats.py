...
class staffOfGold(basicMagicItem):
    def magic(self,player,enemy):
        ...
        baseM.showText("You got "+str(self.charge)+" gold!")
        self.charge-=10
    def __init__ (self):
...
class staffOfLuck(basicMagicItem):
    ...
    def magic(self,player,enemy):
        while True:
            if self.count==0:
                self.count=4
                baseM.showText("Sorry! The lucky number was "+str(luckynumber))
                return
            elif self.count==4:
            ...
            if luckynumber==int(guess):
                ...
                baseM.showText("Oops! You guessed too low!")
                self.count-=1
                print ("You have "+str(self.count)+"guesses left!")
            elif int(guess)>luckynumber:
                baseM.showText("Oops! You guessed too high!")
                self.count-=1
                print ("You have "+str(self.count)+"guesses left!")
...
class amplifyingOrb(basicMagicItem):
    ...
    def magic(self,player,enemy):
        ...
        db.damage *= 2
        baseM.showText("The demonic energies swirl around your Demonic Blade! It doubles in strength! ({})".format(db.damage))
...
class healthPotion(basicPotion):
    def drinkPotion(self, player):
        ...
        baseM.showText("You restored 10 health!")
...
class ohgurGuts(basicPotion):
    def drinkPotion(self, player):
        ...
        if player.health > player.maxHp:
            player.health = player.maxHp
        baseM.showText("You restored 15 health!")
